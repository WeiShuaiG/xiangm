...
import com.umeng.soexample.bean.AddGouwuche;
import com.umeng.soexample.bean.Pinglun;
import com.umeng.soexample.bean.Querygwc;
import com.umeng.soexample.bean.ShouShop;
import com.umeng.soexample.bean.Xiangqing;
...
public class XiangqingActivity extends AppCompatActivity implements IView, View.OnClickListener {
    ...
    private List<Pinglun.ResultBean> mlist = new ArrayList<>();
    ...
    public void success(Object data) {
        if (data instanceof Xiangqing) {
            ...
            if (((Querygwc) data).getStatus().equals("0000")) {
                ...
                presenter.startRequest(Contacts.GWC_ADD, body, head, AddGouwuche.class);
            }
    ...
    private void isWhatCommonList() {
        ...
        if (rxxpBean instanceof ShouShop.ResultBean.RxxpBean.CommodityListBean) {

            Map<String, String> map = new HashMap<>();
            commodityId = ((ShouShop.ResultBean.RxxpBean.CommodityListBean) rxxpBean).getCommodityId();
            ...
            presenter.startShoushop(Contacts.SHOU_XIANGQING, map, headMap, Xiangqing.class);

        } else if (rxxpBean instanceof ShouShop.ResultBean.MlssBean.CommodityListBeanXX) {
            Map<String, String> map = new HashMap<>();
            commodityId = ((ShouShop.ResultBean.MlssBean.CommodityListBeanXX) rxxpBean).getCommodityId();
            map.put("commodityId", String.valueOf(commodityId));
            ...
            headMap.put("sessionId", sessionId);
            presenter.startShoushop(Contacts.SHOU_XIANGQING, map, headMap, Xiangqing.class);
        } else if (rxxpBean instanceof ShouShop.ResultBean.PzshBean.CommodityListBeanX) {
            Map<String, String> map = new HashMap<>();
            commodityId = ((ShouShop.ResultBean.PzshBean.CommodityListBeanX) rxxpBean).getCommodityId();
            map.put("commodityId", String.valueOf(commodityId));
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_cart:
                ...
                presenter.startShoushop(Contacts.GWC_QUERY,null,head,Querygwc.class);
            case R.id.btn_buy:
                break;
        }
